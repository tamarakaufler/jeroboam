use utf8;
package VotingPoll::Schema::VotingPollDB::Result::Party;
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QoQVDS5UP9mpMRtqbWH6uQ

__PACKAGE__->many_to_many(
  "constituencies",
  "constituency_parties", "constituency"
);
